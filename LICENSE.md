...
Subject to the license terms, users may share and adapt the original licensed material, including for commercial purposes.

Attribution is required. Users must provide appropriate credit, link to the license, and indicate whether changes were made.
...
CC BY 4.0 applies only to original project content that the applicable licensor has the right to license.

Third-party quotations, figures, photographs, datasets, standards, manufacturer materials, trademarks, logos, publications, and other referenced content remain subject to their respective rights and terms unless a specific license or public-domain status is stated.

Public-domain material remains in the public domain.

Nothing in this project license notice limits rights that users may otherwise have under applicable law.
