...
When electrical concepts are required, they should be introduced only to the level needed to understand the packaging problem.
...
5. **What can an engineer do about it?**
...
The book should use enough theory to support engineering judgment, but should avoid unnecessary mathematical depth.
...
The working eight-chapter structure is:
...
The goal is to create a practical bridge between fundamental engineering knowledge and the real design, manufacturing, thermal, mechanical, electrical, and reliability problems encountered in electronic products.
